...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ !empty(auth()->user()->image)? asset('public/upload/user_image/'.auth()->user()->image) : asset('public/upload/user_image/profile.jpg') }}" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
        <a href="{{route('profile-management.profile')}}" class="d-block">{{auth()->user()->name}}</a>
      </div>
    </div>
    <nav class="mt-2">
